...
## Due on: Wednesday, June 24, 2026, at 11:59 pm ET. 
...
2. 35% - Problem 1 (get_year_type)
3. 35% - Problem 2 (get_triangular_number_list)
...
The key commands you may need to use in this assignment (and at other times) are:
...
Modify the `get_year_type` function by adding additional lines of code so that it solves the following problem:
...
Modify the `get_triangular_number_list` function by adding additional lines of code so that it solves the following problem:
