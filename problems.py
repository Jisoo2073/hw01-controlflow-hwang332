...
if __name__ == '__main__' :
    ...
    print("\nProblem 0:")
    print("Student answer was:", is_divisible_by_3(1), "    Problem 0 answer correct?",is_divisible_by_3(1)=='not divisible', )
    print("Student answer was:", is_divisible_by_3(2), "    Problem 0 answer correct?",is_divisible_by_3(2)=='not divisible', )
    print("Student answer was:", is_divisible_by_3(3), "    Problem 0 answer correct?",is_divisible_by_3(3)=='divisible', )
    print("Student answer was:", is_divisible_by_3(4), "    Problem 0 answer correct?",is_divisible_by_3(4)=='not divisible', )
    ...
    print("\nProblem 2:")
    print("Problem 2 answer correct?",get_triangular_number_list(8)==[1, 3, 6], "      Student answer was:", get_triangular_number_list(8))
    print("Problem 2 answer correct?",get_triangular_number_list(10)==[1, 3, 6, 10], "      Student answer was:", get_triangular_number_list(10))
    print("Problem 2 answer correct?",get_triangular_number_list(16)==[1, 3, 6, 10, 15], "      Student answer was:", get_triangular_number_list(16))
    print("Problem 2 answer correct?",get_triangular_number_list(21)==[1, 3, 6, 10, 15, 21], "      Student answer was:", get_triangular_number_list(21))
